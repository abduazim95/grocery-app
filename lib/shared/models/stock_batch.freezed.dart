...
/// @nodoc
@JsonSerializable()
class _$StockBatchImpl extends _StockBatch {
  ...
  @override
  String toString() {
    return 'StockBatch(id: $id, storeId: $storeId, productId: $productId, quantity: $quantity, expiresAt: $expiresAt, receivedAt: $receivedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, storeId, productId, quantity, expiresAt, receivedAt);
...
abstract class _StockBatch extends StockBatch {
