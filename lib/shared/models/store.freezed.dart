...
class _$StoreImpl implements _Store {
  const _$StoreImpl(
      {required this.id,
      required this.name,
      @JsonKey(defaultValue: '') this.address,
  ...
  @override
  String toString() {
    return 'Store(id: $id, name: $name, address: $address, managerId: $managerId, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, address, managerId, createdAt);
...
abstract class _Store implements Store {
  const factory _Store(
          ...
          @JsonKey(defaultValue: '') final String? address,
